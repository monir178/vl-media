...
export default function LongTime() {
  return (
    <div id="about">
      ...
      <h1 className="uppercase text-3xl md:text-4xl font-bold text-center mb-4 font-sans py-6 lg:py-0">About me</h1>
        <ReactLenis root>
          <section className="text-white w-full ">
            <div className="grid grid-cols-1 xl:grid-cols-2 xl:gap-6 2xl:gap-20 ">
              ...
              <div className="grid space-y-10 xl:py-80 ">
                ...
                <p className="text-gray-400">
                  They followed the traditional advice of “pick a narrowly
                  defined niche, and stick to it.”
                </p>
                <p className="text-gray-400">
                ...
                <p className="text-gray-400">
                  I had an audience of people who had no idea who I was and had
                  no interest in my brand beyond the ultra-specific thing they
                  followed me for.
                </p>
